...
Layered specs (`Montana Protocol v35.25.1.md`, `Montana Network v1.1.0.md`, `Montana App v3.12.0.md`) и Rust workspace (19 крейтов) — большая система. Чтобы новый ИИ-агент не тратил часы на reverse-engineering контекста, роли в этой папке формализуют:
...
| — | `ГЛОССАРИЙ.md` | Термины (TimeChain, sequential delay, gates, invariants, Pre-mainnet, SSOT и др.) |
| — | `КАРТА-РОЛЕЙ.md` | Какую роль когда использовать |
| 01 | `01-АРХИТЕКТОР-СПЕКИ.md` | Дизайн протокола — изменения в layered specs |
| 02 | `02-КРИТИК-СПЕКИ.md` | Adversarial review спеки — поиск дыр |
| 03 | `03-АРХИТЕКТОР-КОДА.md` | Реализация на Rust — изменения в `Code/crates/` |
