...
Все 4 Storage Cards согласованы с [I-14] requirements (Gate 14, role architect CLAUDE.md). cost-based фрагменты помечены `n/a` единообразно через [I-15] денежного отказа; защита time-based.
