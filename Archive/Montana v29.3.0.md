...
| R_BASELINE (baseline emission) | 13 Ɉ/окно forever | 13 на третьем масштабе: D = 13×10⁹, VDF entry = 13×10³, baseline emission = 13×10⁰. Константа вечной денежной политики |
...
| chain_length_snapshot | скользящее окно 6τ₂ (120 960 окон) | Количество cemented BundledConfirmation за последние 6τ₂. Основа lottery_weight. Новый узел через 6τ₂ выходит на равный snapshot со старожилом. Цифровой корень 6 — Tesla |
