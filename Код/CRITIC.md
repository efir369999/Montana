...
Сопутствующая роль архитектора реализации — `Код/CLAUDE.md`. Инварианты [C-1] SSOT и [C-2] Spec Flow Pre-verification применяются в дополнение к родительским [I-1]..[I-9].
...
- Основной файл: `/Users/kh./Python/Ничто/Монтана/Русский/Протокол/Код/CRITIC.md` — весь файл, от первой до последней строки.
- Родительский контекст: `/Users/kh./Python/Ничто/Монтана/Русский/Протокол/CRITIC.md` — если не в контексте, прочитать; иначе подтвердить наличие в контексте.
- Смежные роли (для границ scope): `/Users/kh./Python/Ничто/Монтана/Русский/Протокол/Код/CLAUDE.md` — для понимания архитекторских правил и инвариантов [C-1]/[C-2].
...
- Архитектурные решения (как сгруппированы crate, где граница модулей) → `Код/CLAUDE.md`
...
- Правило автокоммита в `Протокол/Код/` касается архитектора (после применения правки). Критик публикует findings в чат, файлы не трогает.
