...
fn code_field_value(name: &str) -> Option<Option<u128>> {
    ...
    match name {
        ...
        "vdf_entry_windows" => scalar(p.vdf_entry_windows as u128),
        ...
        "adaptive_vdf_threshold" => scalar(p.adaptive_vdf_threshold as u128),
        "adaptive_vdf_multiplier" => scalar(p.adaptive_vdf_multiplier as u128),
