...
fn exit_node_label(ip: &str) -> Option<(&'static str, &'static str)> {
    match ip {
        "91.132.142.42" => Some(("helsinki", "Хельсинки")),
        "89.19.208.158" => Some(("frankfurt", "Франкфурт")),
...
mod tests {
    ...
    fn test_exit_node_label() {
        assert_eq!(exit_node_label("91.132.142.42"), Some(("helsinki", "Хельсинки")));
        assert_eq!(exit_node_label("89.19.208.158"), Some(("frankfurt", "Франкфурт")));
