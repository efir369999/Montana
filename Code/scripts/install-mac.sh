...
log "  2. Дабл-клик «6. Запустить узел»    — БОЕВОЙ РЕЖИМ, реальный SSHA"
log ""
log "Жизненный цикл узла на M-class Mac (production D из Genesis Decree (mt-genesis)):"
log "  Phase 1: Bootstrap → CandidateSsha  (~10 часов wall-clock SSHA)"
log "  Phase 2: CandidateSsha → Registered (NodeRegistration через canonical)"
