...
log ""
log "Node lifecycle:"
log "  Phase 1: Bootstrap → CandidateSsha   (sequential SHA-256 chain to ssha_chain_length ≥ τ₂)"
log "  Phase 2: CandidateSsha → Registered  (NodeRegistration via canonical apply_*)"
