...
**Версия роли:** 3.14.0 (2026-05-21) — Metzdowd audience principle added
...
- Для роли критика: `/Users/kh./Python/Ничто/Montana/Russian/Протокол/CRITIC.md` — весь файл, от первой до последней строки.
- Для роли архитектора: `/Users/kh./Python/Ничто/Montana/Russian/Протокол/CLAUDE.md` — весь файл.
...
Специфично для sequential-delay / TimeChain систем. Атакующий с hardware advantage (×3-10 ASIC vs commodity CPU для SHA-256) получает специфический attack surface: pre-computation canonical inputs + grinding attacker-chosen полей.
...
Deep closure — принцип **[C-4] End-to-End Observable Closure** из роли архитектора кода (Code/CLAUDE.md v1.7.0+): каждый recovery-класс механизма закрывается сразу по четырём точкам (spec / roadmap / code / example). Pass 20 критика — enforcement этого принципа со стороны adversarial review.
