...
cd "/Users/kh./Python/Ничто/Montana/Russian/Протокол/Code" && cargo fmt --all -- --check && cargo clippy --all-targets -- -D warnings
cd "/Users/kh./Python/Ничто/Montana/Russian/Протокол/Code" && cargo test --all
cd "/Users/kh./Python/Ничто/Montana/Russian/Протокол/Code" && grep -rn "unsafe \|// SAFETY:" crates/mt-crypto/src/lib.rs
cd "/Users/kh./Python/Ничто/Montana/Russian/Протокол/Code" && grep -n "zeroize\|Zeroizing" crates/mt-mnemonic/src/pbkdf2.rs crates/mt-mnemonic/src/hkdf.rs crates/mt-mnemonic/src/hmac.rs
cd "/Users/kh./Python/Ничто/Montana/Russian/Протокол/Code" && grep -nE "(void\*)" crates/mt-crypto-native/csrc/mt_crypto.c
