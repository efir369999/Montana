...
**Эталонная реализация:** Rust, Apache-2.0 / MIT. Двадцать три крейта, включая `mt-timechain`, `mt-consensus`, `mt-lottery`, `mt-crypto`, `mt-net`, `mt-noise-pq`. Спецификация: [Whitepaper Montana v0.1.0.md](../Whitepaper%20Montana%20v0.1.0.md) и [Montana Protocol v35.25.1](../Montana%20Protocol%20v35.25.1.md).
