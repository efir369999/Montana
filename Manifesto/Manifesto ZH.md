...
**参考实现：** Rust，Apache-2.0 / MIT。二十三个 crate，包括 `mt-timechain`、`mt-consensus`、`mt-lottery`、`mt-crypto`、`mt-net`、`mt-noise-pq`。规范：[Whitepaper Montana v0.1.0.md](../Whitepaper%20Montana%20v0.1.0.md) 与 [Montana Protocol v35.25.1](../Montana%20Protocol%20v35.25.1.md)。
